...
// in the previous file (14.12...error.php) we demonstrated the problem
// in this file we are actually going to fix it
...
if ($request_method === 'POST') {
    ...
    // so we're able to access them in subsequent requests
    $_SESSION['valid'] = $valid;
    $_SESSION['errors'] = $errors;
    $_SESSION['inputs'] = $inputs;

    // redirect to the page itself
    // if $_SERVER['PHP_SELF'] did not work, replace 'Location: index.php' this with it
    header($_SERVER['PHP_SELF'], true, 303);
    exit;
